...
void draw() {
     ...
     */
        ...
        ImGui::Begin("CRaZy HaX V2:", NULL, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoCollapse);
        ImGui::Text("Mod INFO:");
        if (ImGui::Button("Info", ImVec2(75.0f, 50.0f))) {
        	FLAlertLayer::create("CRaZy HaX V2", "Made By <cb>GMP</c>", "Close")->show();
        }
        if (ImGui::Button("Credits", ImVec2(75.0f, 50.0f))) {
            FLAlertLayer::create("CRaZy HaX V2", "<cb>Prevter:</c> His ImGui Cocos Template\n<cr></c>!", "Close")->show();
        }
        ImGui::End();
}
